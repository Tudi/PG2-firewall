...
#define IOCTL_PEERGUARDIAN_CONNECTION_LIMIT			CTL_CODE_PEERGUARDIAN(4,FILE_WRITE_DATA)
#define IOCTL_PEERGUARDIAN_SET_PORT					CTL_CODE_PEERGUARDIAN(5,FILE_WRITE_DATA)
#define IOCTL_PEERGUARDIAN_ADD_PERMA_ALLLOW			CTL_CODE_PEERGUARDIAN(6,FILE_WRITE_DATA)
#define IOCTL_PEERGUARDIAN_SET_PORT_DET				CTL_CODE_PEERGUARDIAN(7,FILE_WRITE_DATA)
#define IOCTL_PEERGUARDIAN_SET_FLOOD_DET			CTL_CODE_PEERGUARDIAN(8,FILE_WRITE_DATA)
//#define IOCTL_PEERGUARDIAN_ASSIGN_BANLIST_BUFF		CTL_CODE_PEERGUARDIAN(6,FILE_WRITE_DATA)
//
...
#define MAX_IP_BANS_PER_UPDATE 200
